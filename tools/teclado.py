...
class MeuTeclado:
    ...
    def precionar(self, tecla):
        ...
        win32api.SendMessage(self.hwnd, win32con.WM_KEYDOWN, self.dicionario_teclado[tecla], 0)
        sleep(0.5)
        win32api.SendMessage(self.hwnd, win32con.WM_KEYUP, self.dicionario_teclado[tecla], 0)
